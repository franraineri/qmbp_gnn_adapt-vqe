...
# HardwareDeployer (V6.0 legacy) and HardwareDeployerV61 imported lazily
# to avoid pulling in qiskit_algorithms / heavy deps at package import time.
# V6.1 (recommended): from src.poc.v6.hardware_deployer_v61 import HardwareDeployerV61
# V6.0 (legacy only): from src.poc.v6.hardware_deployer import HardwareDeployer
