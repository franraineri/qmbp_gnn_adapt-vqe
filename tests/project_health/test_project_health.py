...
class TestFigureRegistry:
    ...
    def test_registry_has_all_figures(self):
        ...
        from project_health.figures.health_figures import registry
    ...
    def test_figures_generate_from_analysis(self):
        ...
        from project_health.figures.health_figures import ROOT, FigureConfig, generate_figures

        diag_path = ROOT / "results" / "analysis" / "raw_data" / "all_diagnostics.json"
        if not diag_path.exists():
            pytest.skip("results/analysis/raw_data/all_diagnostics.json not available")
    ...
    def test_figure_config_defaults(self):
        ...
        from project_health.figures.health_figures import FigureConfig
