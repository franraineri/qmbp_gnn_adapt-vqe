...
class TestStatePersistence:
    ...
    def test_load_previous_state_no_file(self, tmp_path):
        ...
        from project_health.state import load_previous_state
    ...
    def test_save_and_load_roundtrip(self, tmp_path):
        ...
        from project_health.state import load_previous_state, save_current_state
    ...
    def test_save_state_includes_metadata(self, tmp_path):
        ...
        from project_health.state import save_current_state
    ...
    def test_detect_delta_first_run(self, tmp_path):
        ...
        from project_health.state import detect_delta
    ...
    def test_detect_delta_new_files(self, tmp_path):
        ...
        from project_health.state import detect_delta, save_current_state
...
class TestCoverageGapDetection:
    ...
    def test_detect_missing_p1_noiseless(self):
        ...
        from project_health.coverage import detect_coverage_gaps
...
class TestCoverageComputeStats:
    ...
    def test_compute_noiseless_stats_pass_rate(self):
        ...
        from project_health.coverage import compute_noiseless_stats
    ...
    def test_compute_vqe_quality_chain_breaks(self):
        ...
        from project_health.coverage import compute_vqe_quality
    ...
    def test_compute_mpnn_quality_overfit_warnings(self):
        ...
        from project_health.coverage import compute_mpnn_quality
    ...
    def test_compute_distribution_counts(self):
        ...
        from project_health.coverage import compute_distribution
        from project_health.digest.models import NoiselessResult
    ...
    def test_compute_noisy_stats_empty(self):
        ...
        from project_health.coverage import compute_noisy_stats
    ...
    def test_compute_timing_stats(self):
        ...
        from project_health.coverage import compute_timing_stats
...
class TestVerifyResults:
    ...
    def test_scan_results_directory_parses_files(self, tmp_path, monkeypatch):
        ...
        from project_health.analysis import verify_results
        from project_health.analysis.verify_results import scan_results_directory

        # Monkeypatch ROOT so relative_to works with tmp_path
...
class TestReporter:
    ...
    def test_format_text_contains_sections(self):
        ...
        from project_health.reporter import format_text
    ...
    def test_format_json_valid(self):
        ...
        from project_health.reporter import format_json
    ...
    def test_format_markdown_structure(self):
        ...
        from project_health.reporter import format_markdown
    ...
    def test_generate_timestamped_filename(self):
        ...
        from project_health.reporter import generate_timestamped_filename
...
class TestModelsSerializer:
    ...
    def test_gap_type_enum_values(self):
        ...
        from project_health.models import GapType
    ...
    def test_health_report_to_dict_nested_dataclasses(self):
        ...
        from project_health.models import HealthReport, VQEQualityStats
    ...
    def test_coverage_gap_default_values(self):
        ...
        from project_health.models import CoverageGap, GapType, Priority
...
class TestActionDerivation:
    ...
    def test_no_actions_when_healthy(self):
        ...
        from project_health.coverage import derive_actions
    ...
    def test_chain_break_generates_action(self):
        ...
        from project_health.coverage import derive_actions
        from project_health.models import VQEQualityStats
    ...
    def test_overfit_generates_action(self):
        ...
        from project_health.coverage import derive_actions
        from project_health.models import MPNNQualityStats
...
class TestRegimeBoundaryConsistency:
    ...
    def test_coverage_uses_preflight_p1(self):
        ...
        from project_health.coverage import P1_VALID_REGIME as cov_p1
    ...
    def test_coverage_uses_preflight_p2(self):
        ...
        from project_health.coverage import P2_VALID_REGIME as cov_p2
