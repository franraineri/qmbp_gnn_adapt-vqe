#!/usr/bin/env python3
"""Audit the energy correction pipeline for potential bugs.
...
Usage (as module):
    python -m project_health.analysis.validation.pipeline_consistency

Usage (standalone):
    .venv/bin/python project_health/analysis/validation/pipeline_consistency.py
"""
...
def main() -> int:
    """Run all pipeline consistency audits. Returns 0 (info-only)."""
    global N_ISSUES
    N_ISSUES = 0
    ...
    print("\n" + "=" * 70)
    return 0  # Info-only — no hard failures
