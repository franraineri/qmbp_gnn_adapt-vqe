...
t0 = time.time()
from qmbp_simulation.execution.noisy_utils import NoisyEstimatorConfig, noisy_estimate
...
print(
    f"   OK {time.time() - t0:.1f}s E={pea.extrapolated_value:.4f} R2={pea.r_squared:.3f}",
    flush=True,
)
