...
def main() -> None:
    ...
    envelope = build_result_envelope(
        ...
        summary={
            ...
            "pass_rate": sum(hypotheses.values()) / max(len(hypotheses), 1),
            **all_summaries,
        },
        elapsed_s=elapsed,
    ...
    # Add analysis wrapper for digest/scanner compatibility
    envelope["analysis"] = {
        "experiment_id": "E4b_hardware_readiness",
        "category": "E",
        "hypothesis": "TFIM+longitudinal behaves like standard TFIM on hardware metrics",
        "n_seeds": len(SEEDS),
        "summary": {
            "pass_rate": sum(hypotheses.values()) / max(len(hypotheses), 1),
            "hypotheses": hypotheses,
