...
for case in TEST_CASES:
    ...
    config = VQEConfig(
        method="COBYLA", p_layers=1, n_restarts=1,
        maxiter=100, enable_callbacks=False,
    )
    ...
    print(f"  Deterministic: E={res_det.energy:.8f}, dE/gap={de_det:.6f}, "
    ...
    print(f"  Stochastic:    E={res_sto.energy:.8f}, dE/gap={de_sto:.6f}, "
    ...
    print(f"  Both pass 5%: det={'PASS' if de_det < 0.05 else 'FAIL'}, "
