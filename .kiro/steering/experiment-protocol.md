...
□ python project_health/compare.py --all → no crash, experiment listed
...
4. Compare against previous run (auto-generated by `project_health/compare.py`)
