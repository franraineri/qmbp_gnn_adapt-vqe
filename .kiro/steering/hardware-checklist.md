...
- [ ] Run automated post-execution validation:
  ```bash
  .venv/bin/python _deprecated/_deprecated/_deprecated/_deprecated/_deprecated/_deprecated/_deprecated/_deprecated/_deprecated/scripts/verify_affine_bug.py --validate results/hardware/run_XXXXXXXX_XXXXXX
  ```
