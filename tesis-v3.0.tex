...
\caption{Comparación GNN (sin BatchNorm) vs. interpolación de scipy para generalización cross-N. Ambos métodos logran $\Delta E/\text{gap} \ll 5\%$ en el régimen de 2 parámetros ($p = 1$), pero la MPNN es la única opción viable para el régimen bond-resolved de 79 dimensiones donde scipy no puede operar.}
