...
\begin{itemize}
    ...
    \item \textbf{Versiones 7--9:} Extensión sistemática a múltiples topologías (V7: 12/22 experimentos), Heisenberg como caso negativo (V9: 30 ejecuciones confirmando límite fundamental)
